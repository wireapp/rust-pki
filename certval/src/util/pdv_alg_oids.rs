...
///     ecdh(12) }
pub const PKIXALG_DH: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.1.12");

/// secp192r1 OBJECT IDENTIFIER ::= {
///     iso(1) member-body(2) us(840) ansi-X9-62(10045) curves(3)
///     prime(1) 1 }
pub const PKIXALG_SECP192R1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.2.840.10045.3.1.1");

/// sect163k1 OBJECT IDENTIFIER ::= {
///     iso(1) identified-organization(3) certicom(132) curve(0) 1 }
pub const PKIXALG_SECP163K1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.1");

///    sect163r2 OBJECT IDENTIFIER ::= {
///     iso(1) identified-organization(3) certicom(132) curve(0) 15 }
pub const PKIXALG_SECP163R2: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.15");

///    secp224r1 OBJECT IDENTIFIER ::= {
///     iso(1) identified-organization(3) certicom(132) curve(0) 33 }
pub const PKIXALG_SECP224R1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.33");

///    sect233k1 OBJECT IDENTIFIER ::= {
///     iso(1) identified-organization(3) certicom(132) curve(0) 26 }
pub const PKIXALG_SECP233K1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.26");

///    sect233r1 OBJECT IDENTIFIER ::= {
///     iso(1) identified-organization(3) certicom(132) curve(0) 27 }
pub const PKIXALG_SECP233R1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.27");

///    secp256r1 OBJECT IDENTIFIER ::= {
///     iso(1) member-body(2) us(840) ansi-X9-62(10045) curves(3)
///     prime(1) 7 }
pub const PKIXALG_SECP256R1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.2.840.10045.3.1.7");

///    sect283k1 OBJECT IDENTIFIER ::= {
///     iso(1) identified-organization(3) certicom(132) curve(0) 16 }
pub const PKIXALG_SECP283K1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.16");

///    sect283r1 OBJECT IDENTIFIER ::= {
///     iso(1) identified-organization(3) certicom(132) curve(0) 17 }
pub const PKIXALG_SECP283R1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.17");
...
pub const PKIXALG_SECP409K1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.36");

///    sect409r1 OBJECT IDENTIFIER ::= {
///     iso(1) identified-organization(3) certicom(132) curve(0) 37 }
pub const PKIXALG_SECP409R1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.37");

///    secp521r1 OBJECT IDENTIFIER ::= {
///     iso(1) identified-organization(3) certicom(132) curve(0) 35 }
pub const PKIXALG_SECP521R1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.35");

///    sect571k1 OBJECT IDENTIFIER ::= {
///     iso(1) identified-organization(3) certicom(132) curve(0) 38 }
pub const PKIXALG_SECP571K1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.38");

///    sect571r1 OBJECT IDENTIFIER ::= {
///     iso(1) identified-organization(3) certicom(132) curve(0) 39 }
pub const PKIXALG_SECP571R1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.3.132.0.39");
...
pub const PKIXALG_RSAES_OAEP: ObjectIdentifier =
    ObjectIdentifier::new_unwrap("1.2.840.113549.1.1.7");

/// id-pSpecified  OBJECT IDENTIFIER  ::=  { pkcs-1 9 }
pub const PKIXALG_PSPECIFIED: ObjectIdentifier =
    ObjectIdentifier::new_unwrap("1.2.840.113549.1.1.9");

/// id-mgf1  OBJECT IDENTIFIER  ::=  { pkcs-1 8 }
pub const PKIXALG_MGF1: ObjectIdentifier = ObjectIdentifier::new_unwrap("1.2.840.113549.1.1.8");

/// id-RSASSA-PSS  OBJECT IDENTIFIER  ::=  { pkcs-1 10 }
pub const PKIXALG_RSASSA_PSS: ObjectIdentifier =
